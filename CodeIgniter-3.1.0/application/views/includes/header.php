								...
								<div class="row">
									<nav class="col-md-12">
										...
										<ul class="nav nav-tabs nav-justified" role="nav">
											<div class="row">
											<div class="col-md-4"><div class="text-center"><li class="go" role="presentation"><a class="nav-button" href="<?php echo site_url() . '/Welcome/index';?>">Home</a></li></div></div>
